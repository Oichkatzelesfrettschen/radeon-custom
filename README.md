...
version axes remain distinct: 0.8.1-1 is the active source pin and package
...
| Radeon DKMS package recipe 0.8.1-1 pins the signed `radeon-unified-0.8.1-profiled-source` checkpoint at source commit `ec5b88802441720b0b972b1b2a92e53171094f31` and driver tree `6fd8d3c6ec245c31f195ef86c15fadf5e206642d` | source pin verification, split package profile checks, package-input checksum verification, and source/profile self-tests pass at the packaging commit. The repository carries no 0.8.1-1 release artifact attestation, package signature, package installation record, loaded module identity, controlled workload, or silicon verdict. Version 0.8.1-1 is the active package recipe and target compile authority; version 0.7-1 remains the loaded production authority |
...
# Exact action identities pass, and 15 workflow mutation classes fail
