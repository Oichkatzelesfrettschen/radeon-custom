...
| --- | --- |
| Unified DKMS package 0.3-96 exports the signed legacy-equivalent driver tree, normalizes DKMS source directories to mode 0755, and composes trusted root-build and package KCFLAGS through one policy helper | compile verification pending on 6.18.38-2-cachyos-lts and 7.1.4-1-cachyos; package export, disposable DKMS lifecycle, target install, and load not run |
